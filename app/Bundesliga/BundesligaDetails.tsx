    ...
    async function fetchStandings() {
      try {
        ...
        const overallRes = await fetch(
          'https://free-api-live-football-data.p.rapidapi.com/football-get-standing-all?leagueid=54',
          apiHeaders,
        );
        ...
        const homeRes = await fetch(
          'https://free-api-live-football-data.p.rapidapi.com/football-get-standing-home?leagueid=54',
          apiHeaders,
        );
        ...
        const awayRes = await fetch(
          'https://free-api-live-football-data.p.rapidapi.com/football-get-standing-away?leagueid=54',
          apiHeaders,
        );
        ...
        setError('Error fetching Bundesliga standings.');
        console.error('Error fetching Bundesliga standings:', err);
      } finally {
        setLoading(false);
      }
    }
